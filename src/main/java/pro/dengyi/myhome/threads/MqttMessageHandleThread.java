...
public class MqttMessageHandleThread implements Runnable {
    ...
    public MqttMessageHandleThread(StringRedisTemplate stringRedisTemplate, DeviceDao deviceDao, CategoryFieldDao categoryFieldDao, String topic, MqttMessage message) {
